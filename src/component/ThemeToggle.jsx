        ...
        <div className="transition duration-500 ease-in-out rounded-full p-2">
            {theme === 'dark' ? (
                <button
                    ...
                    className=" dark:text-white text-2xl cursor-pointer rounded-full hover:bg-gray-700 p-2"
                >
                ...
                <button
                    type="button"
                    onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                    className="text-black dark:text-gray-400 text-2xl cursor-pointer rounded-full hover:bg-gray-300 p-2"
                >
